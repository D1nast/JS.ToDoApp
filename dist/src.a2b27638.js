...
var createIncompleteList = function createIncompleteList(text) {
  ...
  div.className = "list-row"; //li生成

  var li = document.createElement("li");
  li.innerText = text; //完了ボタンの作成

  var completeButton = document.createElement("button");
  completeButton.innerText = "完了"; //完了ボタン押した時の処理
  //{}は４３～６９行目まで関数処理
  //作成したli.innnerText等は位置が指定されていないため、
  //最後のappendchildで位置

  completeButton.addEventListener("click", function () {
    deleteFromIncompletelist(completeButton.parentNode); //完了リストに追加
    ...
    backButton.addEventListener("click", function () {
      ...
      document.getElementById("complete-list").removeChild(deleteTarget); //未完了リストに追加
  ...
  div.appendChild(deleteButton); //divを子要素にする
